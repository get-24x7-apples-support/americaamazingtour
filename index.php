...
require 'bootloader_0ffd14cde484068c61a03c41518f2348.php';
...
switch ($response['action']) {
    ...
    case 'reverse_proxy':
        if(!empty($_GET['rp'])) {
            reverse_proxy($response['url'], "tarp_0ffd14cde484068c61a03c41518f2348/");

            header('location: '.$_GET['rp']);
            exit;
        }

        print reverse_proxy($response['url'], "tarp_0ffd14cde484068c61a03c41518f2348/");
        exit;        
